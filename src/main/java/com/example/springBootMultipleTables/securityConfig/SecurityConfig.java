...
import com.example.springBootMultipleTables.security.JwtAuthenticationFilter;
@Configuration
@EnableWebSecurity
...
///AuthenticationManager is interface there is method name called  authenticate 
	@Bean
